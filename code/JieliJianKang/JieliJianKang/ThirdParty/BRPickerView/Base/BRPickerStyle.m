        ...
        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
            ...
            if (selectLabel) {
                //if (self.selectRowTextColor) {
                    selectLabel.textColor = [UIColor colorWithRed:36.0/255.0 green:36.0/255.0 blue:36.0/255.0 alpha:1.0];//self.selectRowTextColor;
                //}
                //if (self.selectRowTextFont) {
                selectLabel.font = [UIFont systemFontOfSize:24];//self.selectRowTextFont;
                //}
            }
        });
    //}
