...
class WeatherView: UIView, UITextFieldDelegate, UIPickerViewDelegate, UIPickerViewDataSource{
    ...
    func initUI(){
        ...
        self.addSubview(temperaturePgv)
        ...
        self.addSubview(weathercodeLab)
        ...
        self.addSubview(weathercodePicker)
        ...
        self.addSubview(dateSelectBtn)
        self.addSubview(subSwitchLab)
        self.addSubview(subSwitch)
