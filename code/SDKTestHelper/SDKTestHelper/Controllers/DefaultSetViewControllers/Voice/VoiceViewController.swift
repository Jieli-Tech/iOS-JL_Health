...
class VoiceViewController: BaseViewController,JL_SpeexManagerDelegate {
    func speexManager(_ manager: JL_SpeexManager, status: JL_SpeakType, by originator: JLCMDOriginator, with params: JLRecordParams?) {
    }
    ...
    override func initUI() {
        super.initUI()
        navigationView.title = "Voice transmission decoding"
