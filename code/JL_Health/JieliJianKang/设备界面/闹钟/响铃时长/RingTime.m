...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(selectTime == [indexArray[indexPath.row] intValue]){
        [cell.cellBtn setImage:[UIImage imageNamed:@"icon_choose2_sel"] forState:UIControlStateNormal];
    }else{
        [cell.cellBtn setImage:[UIImage imageNamed:@"icon_choose2_nol"] forState:UIControlStateNormal];
    }
    return cell;
}
